...
<footer id="footer">
    <div class="foter-text">Copyright © 2015 ПРО.СВІТ. Всі права захищені. Designed by Synergy Way</div>
    <?php //wp_nav_menu( array('menu' => 'menu test' )); ?>
    <?php

    add_wicked_footer_aside(wp_nav_menu( array('menu' => 'menu test' )));
