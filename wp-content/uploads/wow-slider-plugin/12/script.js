...
jQuery.fn.wowSlider = function (am) {
    ...
    function N(c) {
        var f = aQ[c], a0 = aI("img", f).attr("title"), a1 = aI("img", f).attr("name"), k = aI(f).data("descr");
        if (!a0.replace(/\s+/g, "")) {
            a0 = ""
        }
        return (a0 ? "<span style='font-size: 2em;'>" + a0 + "</span>" : "") + (k ? "<br><div>" + k +  "</div>" : "") + (a1 ? "<br><a class='homeprog' href=  " + a1 + " >diznatus</a>" : "")
    }
...
function wowsliderVideo(g, b, r) {
    ...
    function j(y, A, B) {
        ...
        if (z[0] && (A || z.attr("data-autoplay-video") || b.autoPlayVideo)) {
            ...
            if (z.css("opacity") < 1) {
                z.css("zIndex", 1).animate({opacity: 1}, 500, B ? B : 0)
            } else {
                if (B) {
                    B()
                }
...
(function () {
    ...
    window.ws_caption_move = function (j, h, d, f) {
        var c = jQuery;
        var g = [{left1: "100%", top2: "100%"}, {left1: "80%", left2: "-50%"}, {
            top1: "-100%",
            top2: "100%",
            distance: 0.7,
            easing: "easeOutBack"
        ...
        if (f) {
            ...
            a = setTimeout(function () {
                ...
                c(m).css({position: "relative", visibility: "hidden"});
                h.show();
                for (var n in g) {
                    if (/\%/.test(g[n])) {
                ...
                c(m[0]).css({left: (g.left1 || 0) + "px", top: (g.top1 || 0) + "px"});
                c(m[1]).css({left: (g.left2 || 0) + "px", top: (g.top2 || 0) + "px"});
                function k(p) {
                    var q = c(m[p]).css("opacity");
                    c(m[p]).css({visibility: "visible"}).css({opacity: 0}).animate({opacity: q}, j.captionDuration, "easeOutCirc").animate({
                        top: 0,
                        left: 0
                    }, {duration: j.captionDuration, easing: (g.easing || e), queue: false})
                }
...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container12").wowSlider({
    effect: "parallax",
    prev: "",
    next: "",
    duration: 20 * 100,
