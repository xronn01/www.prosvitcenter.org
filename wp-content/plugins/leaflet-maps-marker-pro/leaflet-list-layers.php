...
if ( ($deleteselected == '1') && ($deleteassignselected == '1') && current_user_can( $lmm_options[ 'capabilities_delete_others' ]) ) {
	...
	echo '<p><div class="updated" style="padding:10px;">' . sprintf(__('The selected layers (IDs %s) and all assigned markers have been deleted (or the reference to the layer has been removed if marker was assigned to multiple layers)','lmm'), htmlspecialchars($checked_layers)) . '</div>';
