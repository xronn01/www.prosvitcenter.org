...
if (!empty($action)) {
	...
	elseif ($action == 'database_upgrade') {
		...
		echo '<p><div class="updated" style="padding:10px;">' . __('Database upgrade is finished.','lmm') . '</div><br/><a class="button-secondary" href="' . LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_tools">' . __('Back to Tools', 'lmm') . '</a></p>';
		echo '<script type="text/javascript">
				jQuery(function($) {
					$(document).ready(function(){
